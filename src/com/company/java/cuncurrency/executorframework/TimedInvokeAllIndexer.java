...
public class TimedInvokeAllIndexer {
    ...
    public static class Indexer1 implements Runnable{
        ...
        public Indexer1(Weblink weblink) {
            this.weblink = weblink;
        }
        ...
        public void run() {
            ...
            try {
                if (weblink.getHost() != null) {


                    index(weblink.getHtmlPage());
                }
    ...
    public void go(){
        ...
        try {
            ...
            futures = downloader.invokeAll(tasks, Time_Frame + System.nanoTime(), TimeUnit.NANOSECONDS);
        ...
        for(Future<Weblink> future: futures){
            ...
            try {
                ...
                indexer.execute(new Indexer1(future.get()));
            }catch (InterruptedException e)
            {
                e.printStackTrace();
